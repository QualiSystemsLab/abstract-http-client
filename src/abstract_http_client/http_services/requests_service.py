...
from requests.models import HTTPError, HTTPBasicAuth
from abstract_http_client.http_services.http_service_base import AbstractHttpService
...
class RequestsService(AbstractHttpService):
    def __init__(
            self,
            host: str,
            port: int = None,
    ...
    def _send_request(self, http_verb: str, uri: str, json: dict = None, data: dict = None,  headers: dict = None,
                      params: dict = None, files: dict = None, cookies: dict = None, hooks: dict = None,
                      auth: auth_type = None):
        """
    ...
    def request_get(self, uri: str, headers: dict = None, params: dict = None, cookies: dict = None, hooks: dict = None,
                    auth: auth_type = None) -> Response:
        return self._send_request(HttpVerbs.GET, uri, headers=headers, params=params, cookies=cookies, hooks=hooks, auth=auth)

    def request_post(self, uri: str, json: dict = None, data: dict = None, files: dict = None, headers: dict = None,
                     params: dict = None, cookies: dict = None, hooks: dict = None,
                     auth: auth_type = None) -> Response:
        """
        ...
        """
        return self._send_request(HttpVerbs.POST, uri, data, json, headers, params, None, cookies, hooks, auth)

    def request_put(self, uri: str, json: dict = None, data: dict = None, headers: dict = None, params: dict = None,
                    cookies: dict = None, hooks: dict = None,
                    auth: auth_type = None) -> Response:
        return self._send_request(HttpVerbs.PUT, uri, json, data, headers, params, None, cookies, hooks, auth)

    def request_delete(self, uri, headers: dict = None, params: dict = None, cookies: dict = None, hooks: dict = None,
                       auth: auth_type = None) -> Response:
